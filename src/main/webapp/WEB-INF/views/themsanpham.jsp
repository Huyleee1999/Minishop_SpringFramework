...
<!-- Bootstrap Core CSS -->
<link rel="stylesheet" href='<c:url value="/resources/bootstrap-5.0.2-dist/css/bootstrap.min.css"/>'>
<!-- Custom CSS -->
...
<div class="left-content">
   <div class="row">
   		...
   		<form id="form-sanpham" action="">
   			...
   			<input type="text" name="giatien" id="giatien" class="form-control" placeholder="Nhập vào giá tiền"/><br>
   		
   			<span>Dành cho</span> <br>
   			<p><label class="radio-inline">
		      	<input id="rd-nam" type="radio" name="gianhcho" value="nam">Nam
		    </label>
		    <label class="radio-inline">
		      	<input id="rd-nu" type="radio" name="gianhcho" value="nu">Nữ
		    </label></p> 
			  ...
			  <select name="danhmucsanpham" class="form-control" id="danhmucsanpham">
   			...
   			<textarea type="text" name="mota" id="mota" class="form-control" placeholder="Nhập vào mô tả" rows="5"></textarea><br>
    		...
    		<div id="containerchitietsanpham">
    			<div class="chitietsanpham">
					...
					<select name="sizesanpham" class="form-control" id="sizesanpham">
   			  		...
   			  		<input min="1" value="1" type="number" id="soluong" name="soluong" class="form-control" placeholder="Nhập vào số lượng"/><br>
    				<button class="btn-chitiet btn btn-secondary">Thêm chi tiết</button>
    			</div>
    		</div>
		    ...
		    <p>
		      ...
		      <button id="btnThemSanPham" style="margin-right: 10px" class="btn btn-primary"> Thêm sản phẩm</button>
		      <button id="btnCapNhatSanPham" style="margin-right: 10px" class="hidden btn btn-success"> Cập nhật</button>
		      <button id="btnThoat" style="margin-right: 10px" class="hidden btn btn-danger"> Thoát</button>
   		...
   		<div class="col-md-7 col-sm-12"> 			
	   		<div style="float: right">
	   			<button id="xoa-sanpham" style="float: right" class="btn btn-danger"> Xóa</button>	   			
	   		</div>
		   			...
		   			<tr>
		   				<th>
							  ...
							  <label class="form-check-label">
							    <input id="checkall" type="checkbox" class="form-check-input" value="">Option 1
							  </label>
							</div>
		   				</th>
		   				<th>Tên sản phẩm</th>
		   			...
		   			<c:forEach var="value" items="${listSanPham}">
						<tr>
							<td>
								<div class="form-check">
							  		<label class="form-check-label">
							    		<input type="checkbox" class="form-check-input checkboxsanpham" value="${value.getMasanpham()}">
							  		</label>
								</div>
							</td>				
							...
							<td style="color: black" class="capnhatsanpham btn btn-info" data-id="${value.getMasanpham()}">Sửa</td>
						</tr>
					 </c:forEach>
		   		</tbody>
	   		</table>
		   	...
		   	<ul class="pagination pagination-sm">
		   		<c:forEach var = "i" begin = "1" end = "${tongsopage}" >
		   			<c:choose>
		   				<c:when test="${i == 1 }">
		   					<li class="paging-item active"><a style="color: #164112" class="page-link" href="#">${i}</a></li>
		   				</c:when>
		   				
		   				<c:otherwise>
		   					<li class="paging-item"><a style="color: #164112" class="page-link" href="#">${i}</a></li>
		   				</c:otherwise>
		   			</c:choose>  			
		   		</c:forEach>
			</ul>
